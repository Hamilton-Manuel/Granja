...
export interface DatosEntrada { productoId: number; proveedorId?: number; inventarioId: number; cantidadComercial: DecimalInventario; unidadComercial: string; precioTotalIngreso: DecimalInventario; fechaFabricacion?: string | null; fechaVencimiento?: string | null; documentoReferencia?: string | null; motivo?: string | null; observaciones?: string | null; subtipo: "COMPRA" | "INVENTARIO_INICIAL" }
