...
describe("modelo depurado de ficha técnica",()=>{
  ...
  it("identifica peso estimado y conserva sus medidas fuente",()=>{const Obj=Produccion_crearModeloFicha({...ObjBase,mediciones:[{medicionId:1,tipoMedicion:"PESO",valor:"572.3512",pesoLb:"1261.8184",unidadMedida:"KG",metodoObtencion:"ESTIMACION_SCHAEFFER",perimetroToracicoCm:"177.0000",longitudCorporalCm:"198.0000",fechaMedicion:"2026-09-03T10:00:00-06:00",observaciones:null}]});expect(Obj.mediciones[0]?.medicion).toContain("Peso estimado");expect(Obj.mediciones[0]?.medidas).toContain("PT: 177.0000 cm");});
});
