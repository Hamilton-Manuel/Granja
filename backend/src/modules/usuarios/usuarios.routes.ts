...
export function Usuarios_crearRouter(): Router {
  ...
  ObjRouter.get("/accesos", Middleware_requerirAutenticacion, Middleware_requerirPermiso("USUARIOS_ASIGNAR_ROL"), ObjController.Usuarios_listarAccesos);
  ...
  ObjRouter.get("/:usuarioId/accesos", Middleware_requerirAutenticacion, Middleware_requerirPermiso("USUARIOS_ASIGNAR_ROL"), ObjController.Usuarios_obtenerAccesos);
  ObjRouter.patch("/:usuarioId/accesos", Middleware_requerirAutenticacion, Middleware_requerirPermiso("USUARIOS_ASIGNAR_ROL"), ObjController.Usuarios_actualizarAccesos);
