...
const ObjSeleccionMovimientoEnriquecido = {
  ...
  usuarioId: true, proveedorId: true, loteProduccionId: true, animalId: true, alimentacionDetalleId: true, aplicacionSanitariaId: true,
